...
//@Disabled
public final class BlueBackStageWhitePixelFullAuton extends FullAutonOpMode {
    public BlueBackStageWhitePixelFullAuton() {
        super(StartPosition.BLUE_BACK_STAGE, DetectionType.TENSORFLOW);
    }
}
