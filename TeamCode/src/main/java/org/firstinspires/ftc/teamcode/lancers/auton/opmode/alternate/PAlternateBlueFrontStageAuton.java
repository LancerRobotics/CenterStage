...
//@Disabled
public final class PAlternateBlueFrontStageAuton extends FullAutonOpMode {
    public PAlternateBlueFrontStageAuton() {
        super(StartPosition.BLUE_FRONT_STAGE, true, true);
    }
}
