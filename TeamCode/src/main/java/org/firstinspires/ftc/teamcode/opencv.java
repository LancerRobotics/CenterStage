...
public class opencv extends LinearOpMode {
    ...
    double cX = 0; // x coordinate of camera
    double cY = 0; // y coordinate of camera
    double width = 0;
    ...
    class YellowBlobDetectionPipeline extends OpenCvPipeline {
        ...
        private Mat preprocessFrame(Mat frame) {
            ...
            Scalar lowerPurple = new Scalar(230, 100, 100); // slightly less than medium purple
            Scalar upperPurple = new Scalar(320, 255, 255); // purple


            Mat purpleMask = new Mat();
            Core.inRange(hsvFrame, lowerPurple, upperPurple, purpleMask);
